		...
		<p id="message-recipients">
			<span class="highlight">
				...
				<?php if ( bp_get_thread_recipients_count() <= 1 ) : ?>
					...
					<?php _e( 'You are alone in this conversation.', 'thrive' ); ?>

				<?php elseif ( bp_get_max_thread_recipients_to_list() <= bp_get_thread_recipients_count() ) : ?>

					<?php printf( __( 'Conversation between %s recipients.', 'thrive' ), number_format_i18n( bp_get_thread_recipients_count() ) ); ?>
			...
			<a class="button confirm" href="<?php bp_the_thread_delete_link(); ?>" title="<?php esc_attr_e( "Delete Conversation", "thrive" ); ?>"><?php _e( 'Delete', 'thrive' ); ?></a>
		</p>
			...
			<div class="message-box">
				...
				<div class="message-metadata">
					...
					<div class="avatar-box">
						...
						<strong><?php _e( 'Send a Reply', 'thrive' ); ?></strong>
					</div>
				...
				<div class="message-content">
					...
					<div class="submit">
						<input type="submit" name="send" value="<?php esc_attr_e( 'Send Reply', 'thrive' ); ?>" id="send_reply_button"/>
					</div>
